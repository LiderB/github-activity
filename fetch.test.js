    ...
    const expected = [
        {
          ...
          payload: {
            ...
            commits: [
                {
                  sha: '72cd9edba4bd6ea85a890eea45cac751cab65783',
                  author: { email: 'lider.2001@hotmail.com', name: 'LiderB' },
                  message: 's',
                  distinct: true,
                  url: 'https://api.github.com/repos/LiderB/urlshortener/commits/72cd9edba4bd6ea85a890eea45cac751cab65783'
                }
            ]
          },
          public: true,
